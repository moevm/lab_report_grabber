...
def get_args():
    ...
    parser.add_argument("--num_header_rows",
                        type=int, help="Num of header rows")
    parser.add_argument("--full_name_col",
                        type=int, help="Full name column")
    parser.add_argument("--group_col",
                        type=int, help="Group column")
    parser.add_argument("--github_col",
                        type=int, help="Github column")
    parser.add_argument("--works_structure", "-s",
                        type=str, help='Path to works structure')
    parser.add_argument("--prefix",
                        type=str, help="Prefix for repo")
    parser.add_argument("--token_file",
                        type=str, help="Path to token file")
    parser.add_argument("--out_table_name", "-o",
                        type=str, help="Output table name")
